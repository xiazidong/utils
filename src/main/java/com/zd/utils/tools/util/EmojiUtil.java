...
public class EmojiUtil {
     ...
     * 特殊的表情符号
     */
    private static String[] emoji = {"0xA9", "0xAE", "0x2122", "0x2196", "0x2197", "0x2198", "0x2199",
    ...
    private static List<String> emojies = Arrays.asList(emoji);
    ...
    private static boolean isNotEmojiCharacter(char codePoint) {
        boolean flag = codePoint == 0x0 || codePoint == 0x9 || codePoint == 0xA || codePoint == 0xD || codePoint >= 0x20 && codePoint <= 0xD7FF || codePoint >= 0xE000 && codePoint <= 0xFFFD;
        if (flag) {
            flag = !emojies
